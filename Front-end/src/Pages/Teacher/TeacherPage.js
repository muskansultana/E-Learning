...
class TeacherPage extends Component {
  state = {
    ...
    EventNames: ["Interviews", "Hackathon", "Career", "Job"],
    CourseNames: [
      "Web Development",
      "React",
      "ML",
  ...
  categoryHandler = (CourseName) => {
    ...
    if (this.state.EventNames.includes(CourseName))
  ...
  render() {
    ...
    if (this.state.Form.category["Jobs"]) {
      classJobs = ["ButtonClicked"];
    } else classJobs = [];
    if (this.state.Form.category["Career"]) {
      classCareer = ["ButtonClicked"];
    } else classCareer = [];
        ...
        <div className="container-fluid-main">
          ...
          <div className="Teacher-Courses-Buttons-head">
            ...
            <div className="Teacher-Courses-Buttons">
              ...
              <button
                className={classHackathon.join(" ")}
                onClick={() => this.categoryHandler("Hackathon")}
              >
                {" "}
                Hackathon
              </button>
              <button
                ...
                onClick={() => this.categoryHandler("Interview")}
              >
                {" "}
                Interviews
              </button>
              <button
                className={classJobs.join(" ")}
                onClick={() => this.categoryHandler("Jobs")}
              >
                {" "}
                Jobs
              </button>
